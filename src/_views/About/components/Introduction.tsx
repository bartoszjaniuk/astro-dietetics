  ...
  return (
    <section className="w-full h-full bg-white py-8 lg:py-0">
      <div className="flex flex-col-reverse lg:flex-row container responsive-padding mx-auto">
        <div className="flex-1 flex flex-col gap-4 items-center lg:items-start lg:py-8 lg:w-[50%] xl:w-[70%]">
          <SlideY
            component="h2"
            from="top"
          ...
          <SlideX
            component="h2"
            from="left"
            className="text-2xl font-black text-primary text-left lg:text-left"
          >
