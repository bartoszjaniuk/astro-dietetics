...
export const Explication = () => {
	return (
		<div className="flex flex-col-reverse lg:flex-row lg:items-center bg-softGray container responsive-padding mx-auto gap-8 py-8">
			...
			<div className="flex-1 flex flex-col gap-6 items-center justify-center  md:items-start md:pt-8 lg:w-[50%]">
				<SlideX
					component="h2"
					from="left"
					className="text-6xl font-black text-primary text-left lg:text-left"
				>
				...
				<SlideX
					component="p"
					from="left"
					className="font-light text-primary font-lato lg:text-left lg:text-2xl text-3xl"
				>
				...
				<p className="pt-6 text-primary text-2xl font-black uppercase">
					ZMIANA NAWYKÓW ŻYWIENIOWYCH = ZMIANA STYLU ŻYCIA.
				</p>

				<div className="flex flex-col xl:flex-row gap-4 xl:gap-8 justify-center w-full">
					<LinkButton
