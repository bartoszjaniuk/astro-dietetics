...
export const Layout = ({
	...
	return (
		<main className="relative min-h-fit h-screen  w-full bg-white grid grid-cols-1 gap-4 lg:gap-0 lg:grid-cols-[2fr_1fr]">
			<span
			...
			<section className="bg-white min-h-full w-full responsive-padding-screen flex justify-center pt-16 relative">
				...
				<div className="pt-8 w-full h-fit bg-green-400">{children}</div>
			</section>
