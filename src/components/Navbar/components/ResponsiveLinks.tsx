  ...
  return (
    <>
      ...
      <NavigationList isOpen={isOpen}>
        ...
        <NavigationLink path="/kalkulator" title="Kalkulator kalorii" />
        <SocialIcons />
      </NavigationList>
    </>
  );
...
const NavigationList = ({
  ...
  <motion.ul
    ...
    className="text-2xl absolute top-[95px] w-full bg-white left-0 lg:hidden py-6  flex flex-col gap-7 overflow-y-scroll items-center my-auto z-50"
  >
    {children}
  </motion.ul>
);
